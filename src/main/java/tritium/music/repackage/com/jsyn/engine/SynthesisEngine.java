...
package tritium.music.repackage.com.jsyn.engine;
...
import tritium.music.repackage.com.jsyn.devices.AudioDeviceInputStream;
import tritium.music.repackage.com.jsyn.devices.AudioDeviceManager;
import tritium.music.repackage.com.jsyn.devices.AudioDeviceOutputStream;
...
import tritium.music.repackage.com.softsynth.shared.time.ScheduledQueue;
...
public class SynthesisEngine implements Synthesizer {
    ...
    public synchronized void start(int frameRate, int inputDeviceID, int numInputChannels,
        ...
        if (useRealTime) {
            ...
            int engineThreadPriority = Thread.MAX_PRIORITY;
