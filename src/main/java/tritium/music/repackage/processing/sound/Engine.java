...
import tritium.music.repackage.com.jsyn.JSyn;
import tritium.music.repackage.com.jsyn.Synthesizer;
import tritium.music.repackage.com.jsyn.devices.AudioDeviceFactory;
import tritium.music.repackage.com.jsyn.devices.AudioDeviceManager;
import tritium.music.repackage.com.jsyn.devices.javasound.JavaSoundAudioDevice;
import tritium.music.repackage.com.jsyn.ports.UnitInputPort;
import tritium.music.repackage.com.jsyn.engine.SynthesisEngine;
import tritium.music.repackage.com.jsyn.unitgen.ChannelOut;
import tritium.music.repackage.com.jsyn.unitgen.Multiply;
import tritium.music.repackage.com.jsyn.unitgen.UnitGenerator;
import tritium.music.repackage.com.jsyn.unitgen.UnitSource;
...
public class Engine {
	...
	private static AudioDeviceManager createDefaultAudioDeviceManager() {
		...
		return AudioDeviceFactory.createAudioDeviceManager();
	}
	...
	public void remove(UnitGenerator generator) {
		if (this.addedUnits.contains(generator)) {
	...
	protected static void println(String message) {
		System.out.println("[Sound Processing]: " + message);
	}
