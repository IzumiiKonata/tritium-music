...
public class TTexture extends AbstractTexture {
    ...
    public TTexture(GpuTexture texture, GpuTextureView textureView, GpuSampler sampler, boolean closeTexture, boolean closeSampler) {
    ...
    public TTexture(GpuTexture texture, GpuTextureView textureView, GpuSampler sampler) {
