...
import tritium.music.repackage.org.kc7bfi.jflac.frame.*;
import tritium.music.repackage.org.kc7bfi.jflac.io.BitInputStream;
import tritium.music.repackage.org.kc7bfi.jflac.io.RandomFileInputStream;
import tritium.music.repackage.org.kc7bfi.jflac.metadata.*;
import tritium.music.repackage.org.kc7bfi.jflac.util.ByteData;
import tritium.music.repackage.org.kc7bfi.jflac.util.CRC16;
    ...
    private void readStreamSync() throws IOException {
        ...
        for (int i = 0; i < 4; ) {
            ...
            if (x == Constants.STREAM_SYNC_STRING[i]) {
                ...
                throw new DecodeError("Could not find Stream Sync");
                //i = 0;
                //id = 0;
            }
        }
