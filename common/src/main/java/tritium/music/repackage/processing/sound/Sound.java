...
public class Sound {
     ...
     * @param inputDevice  the device id of the sound card from which sound should be
     *                     captured
     ...
     *
     * @param volume the desired output volume, normally between 0.0 and 1.0 (default
     *               is 1.0)
     * @webref Configuration:Sound
     */
