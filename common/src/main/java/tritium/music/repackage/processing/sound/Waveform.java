...
import tritium.music.repackage.com.jsyn.ports.UnitDataQueuePort;
import tritium.music.repackage.com.jsyn.ports.UnitOutputPort;
import tritium.music.repackage.com.jsyn.unitgen.FixedRateStereoWriterSpecial;
...
public class Waveform extends Analyzer {
    ...
    /**
     * @param nsamples number of waveform samples that you want to be able to read at once (a positive integer).
     */
...
//			this.connect(this.writer.dataQueueRight, this.bufferRight, this.dataRight);
     ...
     *
     * @param value an array with as many elements as this Waveform analyzer's number of
     *              samples
     * @return the current audiobuffer of the input source. The array has as
     * many elements as this Waveform analyzer's number of samples
     * @webref Analysis:Waveform
...
*/
     ...
     *
     * @param input the input sound source. Can be an oscillator, noise generator,
