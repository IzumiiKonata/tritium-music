...
public class FFT extends Analyzer {
    ...
    /**
     * @param bufferSize number of frequency bufferSize for the FFT. This parameter needs to
     ...
     *
     * @param target if provided, writes the frequency spectrum into the given array.
     ...
     * will be much lower and usually don't exceed 0.05.
     *
     * @param sample   an array of numbers that describe the waveform to be analyzed
     * @param numBands the number of fft bands requested. Must be a power of 2 (one of 2, 4, 8, 16 etc.)
